...
```
git clone https://github.com/aravind93raja/Project-Route-Planning.git --recurse-submodules
```
or with SSH:
```
git clone https://github.com/aravind93raja/Project-Route-Planning.gitt --recurse-submodules
```
